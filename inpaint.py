...
parser.add_argument('--model_file', type=str, help="Pretrained GAN model",default='dcgan-100.pb')
...
def gen_mask(maskType):
    ...
    if maskType == 'random':
        ...
        mask[np.random.random(image_shape[:2]) < fraction_masked] = 0.0 #Look for more details
...
def main():
    ...
    #Setup directory to read image from
